...
if (isset($_GET['id']) && $_GET['id'] != '') {
  ...
  ?>
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                          <ul class="" style="list-style: none; padding-inline-start: 0px;">
                              <li>
                                Foto Transfer
                                <img class="img-fluid" src="<?=BASE_URL.$row['foto_transfer'];?>" width="200px" height="auto">
                              </li>
                              <li>
                                Bank
        ...
        <?php } ?>
                ...
                <?php if($row['tipe_pembayaran'] == 'transfer' && $row['status_pembayaran'] == 'belum'){ ?>
                    <div class="col-12">
                        <div class="card">
                            <div class="header bg-orange">
                                <h2>
                ...
                <?php } if($row['tipe_pembayaran'] == 'tunai' && $row['status_pembayaran'] == 'belum'){ ?>
                    <div class="col-12">
                        <div class="card">
                            <div class="body">
                                <form role="form" action="page/pembayaran/action/terima1.php" method="POST">
                                  <input type="hidden" name="id" value="<?=$id?>">
                                  <input type="hidden" class="form-control" name="total_dibayar" id="" >
                                 <button type="submit" class="btn btn-warning btn-block btn-oval">Proses</button>
                                </form>
                            </div>
                        </div>
                    </div>

                     <?php } if($row['tipe_pembayaran'] == 'tunai' && $row['status_pembayaran'] == 'COD'){ ?>
                    <div class="col-12">
                        <div class="card">
                            <div class="body">
                               <form role="form" action="page/pembayaran/action/terima.php" method="POST">
