...
if (isset($_GET['id']) && $_GET['id'] != '') {
  $id = $_GET['id'];
  $sql = "SELECT pe.id_pesanan,pe.status,pl.nama, pl.username, pl.telepon, pl.alamat, pe.ongkir, pe.alamat AS alamat_tujuan,pe.id_kurir,
                ...
                <?php if(!isset($row['id_kurir'])){ ?>
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="body">
                                <form role="form" novalidate action="page/pesanan/action/kirim.php" method="POST">
                                    <input type="hidden" name="id" value="<?=$id?>">
                                    <button type="submit" class="btn btn-warning btn-block btn-oval">Kirim</button>
                                </form>
                            </div>
                        </div>
                    </div>
